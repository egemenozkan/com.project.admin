       ...
       <div>
           <table>
               ...
               <tbody>
                   ...
                   <tr id="" data-place-id="${ place.id }">
                       <td>${ place.id }</td>
                       <td>${ place.name! }</td>
                       <td>${ place.language! }</td>
                       <td>${ place.originalName! }</td>
                       <td>${ place.originalLanguage! }</td>
                       <td>${ place.type! }</td>
                       <td></td>
                       <td></td>
                       <td></td>
...
process. Sign in with 
    <#list clientRegistrationList as clientRegistration >
                <a href="/oauth2/authorization/${clientRegistration.registrationId}}" class="text-info">${clientRegistration.clientName}</a> or
     </#list>
</small>
</p>
</div>
