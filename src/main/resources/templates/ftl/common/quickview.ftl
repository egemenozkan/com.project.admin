                ...
                <div class="view-port clearfix quickview-notes" id="note-views">
                    ...
                    <div class="view list" id="quick-note-list">
                        <div class="toolbar clearfix">
                            <ul class="pull-right ">
                                <li>
                                    <a href="datatables.html#" class="delete-note-link"><i class="fa fa-trash-o"></i></a>
                                </li>
                                <li>
                                    <a href="datatables.html#" class="new-note-link" data-navigate="view" data-view-port="#note-views"
                        ...
                        <ul>
                            ...
                            <li data-noteid="1">
                                ...
                                <div class="right pull-right">
                                    ...
                                    <a href="datatables.html#" data-navigate="view" data-view-port="#note-views" data-view-animation="push"><i
                            ...
                            <li data-noteid="2">
                                ...
                                <div class="right pull-right">
                                    ...
                                    <span class="date">12/12/14</span>
                                    <a href="datatables.html#"><i class="fa fa-chevron-right"></i></a>
                    ...
                    <div class="view note" id="quick-note">
                        <div>
                            <ul class="toolbar">
                                <li><a href="datatables.html#" class="close-note-link"><i class="pg-arrow_left"></i></a>
                                </li>
                                <li><a href="datatables.html#" data-action="Bold" class="fs-12"><i class="fa fa-bold"></i></a>
                                </li>
                                <li><a href="datatables.html#" data-action="Italic" class="fs-12"><i class="fa fa-italic"></i></a>
                                </li>
                                <li><a href="datatables.html#" class="fs-12"><i class="fa fa-link"></i></a>
                                </li>
                            </ul>
                            <div class="body">
                                <div>
                    ...
                    <div class="view bg-white">
                        ...
                        <div class="navbar navbar-default navbar-sm">
                            <div class="navbar-inner">
                                ...
                                <a href="datatables.html#" class="inline action p-r-10 pull-right link text-master">
                                    <i class="pg-search"></i>
                                </a>
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="alert-list">
                                        ...
                                        <a href="datatables.html#" class="align-items-center" data-navigate="view" data-view-port="#chat"
                                         data-view-animation="push-parrallax">
                                            <p class>
                                                <span class="text-warning fs-10"><i class="fa fa-circle"></i></span>
                                            </p>
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="alert-list">
                                        ...
                                        <a href="datatables.html#" class="p-t-10 p-b-10 align-items-center" data-navigate="view" data-view-port="#chat"
                                         data-view-animation="push-parrallax">
                                            <p class>
                            ...
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class href="datatables.html#">
                    ...
                    <div class="view chat-view bg-white clearfix">
                        ...
                        <div class="navbar navbar-default">
                            <div class="navbar-inner">
                                ...
                                <a href="datatables.html#" class="link text-master inline action p-r-10 pull-right ">
                                    <i class="pg-more"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="b-t b-grey bg-white clearfix p-l-10 p-r-10">
                            <div class="row">
                                <div class="col-1 p-t-15">
                                    <a href="datatables.html#" class="link text-master"><i class="fa fa-plus-circle"></i></a>
                                </div>
                                ...
                                <div class="col-2 link text-master m-l-10 m-t-15 p-l-10 b-l b-grey col-top">
                                    <a href="datatables.html#" class="link text-master"><i class="pg-camera"></i></a>
                                </div>
                            </div>
                        </div>
