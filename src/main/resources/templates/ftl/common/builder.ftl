<div class="quickview-wrapper  builder hidden-sm hidden-xs" id="builder">
        <div class="p-l-30 p-r-30 ">
            <a class="builder-close quickview-toggle pg-close" data-toggle="quickview" data-toggle-element="#builder" href="datatables.html#"></a>
            ...
            <ul class="nav nav-tabs nav-tabs-simple nav-tabs-primary m-t-10" id="builderTabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="datatables.html#tabLayouts" role="tab" aria-controls="home"><span>Layouts</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="datatables.html#tabThemes" role="tab" aria-controls="profile"><span>Colors</span></a>
                </li>
            </ul>
                    ...
                    <div class="scrollable">
                        <div class="p-l-10 p-r-50">
                            ...
                            <div class="row p-b-35">
                                <div class="col-6 ">
                                    <a class="btn-toggle-layout fs-12 active " data-action="menuDefault" href="datatables.html#"><img alt="Menu divided icon"
                                ...
                                <div class="col-6">
                                    <a class="btn-toggle-layout fs-12" data-action="menuBelow" href="datatables.html#">
                ...
                <div class="tab-pane " id="tabThemes" role="tabcard">
                    <div class="scrollable">
                        <div class="p-l-10 p-r-50">
                            ...
                            <a href="datatables.html#" class="btn-toggle-theme b-a b-grey active theme-selector m-b-30" data-action="default">
                            ...
                            <a href="datatables.html#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="corporate">
                            ...
                            <a href="datatables.html#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="retro">
                            ...
                            <a href="datatables.html#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="unlax">
                            ...
                            <a href="datatables.html#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="vibes">
                            ...
                            <a href="datatables.html#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="abstract">
