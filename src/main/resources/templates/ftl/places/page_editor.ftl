                ...
                <div class=" container-fluid   container-fixed-lg bg-white">
                    <div class="card card-transparent">
                        <div class="card-header ">
                            <div class="card-title">Places  - ${ page.place.name! } [${ page.place.language! }]
                            </div>
                        ...
                        <div class="card-block">
							<form role="form" method="POST" action="/places/pages">
							    <input type="hidden" name="id" value="${ page.id! }"> 
                                <input type="hidden" name="place.id" value="${ page.place.id?long?c! }"> 
                                ...
                                <div class="summernote-wrapper">
                                    <input type="hidden" name="contents[0].id" value="<#if page.contents?has_content>${ page.contents[0].id?long?c! }</#if>">
                                    <textarea id="summernote" name="contents[0].text"><#if page.contents?has_content>${ page.contents[0].text! }</#if></textarea>
								</div>
							    <div>
