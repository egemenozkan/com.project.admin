...
<body class="fixed-header ">
    <div class="login-wrapper ">
        ...
        <div class="bg-pic">
            ...
            <img src="assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src="assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg"
                ...
                <form id="form-login" class="p-t-15" role="form" action="index.html">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-center justify-content-end">
                            <a href="login.html#" class="text-info small">Help? Contact Support</a>
                        </div>
                    </div>
                ...
                <div class="pull-bottom sm-pull-bottom">
                    <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
                        <div class="col-sm-3 col-md-2 no-padding">
                            <img alt class="m-t-5" data-src="assets/img/demo/pages_icon.png" data-src-retina="assets/img/demo/pages_icon_2x.png"
                                height="60" src="assets/img/demo/pages_icon.png" width="60">
                        </div>
                        <div class="col-sm-9 no-padding m-t-10">
                            <p>
                                <small>
                                    ...
                                    <#list clientRegistrationList as clientRegistration>
                                        <a href="/oauth2/authorization/${clientRegistration.registrationId}" class="text-info">${clientRegistration.clientName}</a>
                                        <#sep>or </#sep>
                                    </#list>
                                </small>
                            </p>
    ...
    <div class="overlay hide" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                ...
                <a href="login.html#" class="close-icon-light overlay-close text-black fs-16">
                    <i class="pg-close"></i>
                </a>
